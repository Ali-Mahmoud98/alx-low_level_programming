...
**Files:** [103-exponential.c](103-exponential.c)
...
**Files:** [104-advanced_binary.c](104-advanced_binary.c)
...
**Files:** [105-jump_list.c](105-jump_list.c)
...
**Files:** [106-linear_skip.c](106-linear_skip.c)
...
```
## 14. Big O #6
What is the `time complexity` (average case) of a jump search in a singly linked list of size `n`, using `step = sqrt(n)`? [107-O](107-O)

## 15. Big O #7
What is the `time complexity` (average case) of a jump search in a skip list of size `n`, with an express lane using `step = sqrt(n)`? [108-O](108-O)